...
public final class ExpFunction extends FunctionOnSegment {
    private double parameterA,parameterB;

    public ExpFunction(double upperBound, double lowerBound, double parameterA, double parameterB) {
    ...
    public double getValue(double arg) throws FunctionException {
        ...
        return parameterA * Math.exp(arg) + parameterB;
    }
}
