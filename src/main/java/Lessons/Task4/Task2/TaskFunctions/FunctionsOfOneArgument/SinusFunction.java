...
public final class SinusFunction extends FunctionOnSegment {
    private double parameterA,parameterB;

    public SinusFunction(double upperBound, double lowerBound, double parameterA, double parameterB) {
    ...
    public double getValue(double arg) throws FunctionException {
        ...
        return parameterA * Math.sin(parameterB * arg);
    }
